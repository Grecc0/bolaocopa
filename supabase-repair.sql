-- Correção rápida para permissões e estrutura do Bolão da Copa
...
create policy "public insert participants" on public.participants for insert to anon with check (true);
create policy "public update participants" on public.participants for update to anon using (true) with check (true);
create policy "public delete participants" on public.participants for delete to anon using (true);

create policy "public read matches" on public.matches for select to anon using (true);
create policy "public insert matches" on public.matches for insert to anon with check (true);
create policy "public update matches" on public.matches for update to anon using (true) with check (true);
create policy "public delete matches" on public.matches for delete to anon using (true);

create policy "public read predictions" on public.predictions for select to anon using (true);
create policy "public insert predictions" on public.predictions for insert to anon with check (true);
create policy "public update predictions" on public.predictions for update to anon using (true) with check (true);
create policy "public delete predictions" on public.predictions for delete to anon using (true);
...
create policy "public update settings" on public.settings for update to anon using (true) with check (true);
create policy "public delete settings" on public.settings for delete to anon using (true);

-- Realtime: se der erro nessa parte, o bolão ainda funciona; só a atualização automática imediata pode ficar instável.
do $$
begin
